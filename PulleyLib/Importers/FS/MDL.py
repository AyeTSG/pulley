# PulleyLib.Importers.FS.MDL
# Imports .MDL files from FS
...
import PulleyLib.Importers.FS.Other
...
def import_file(file_path, depot_path, config_handle, profile):
    ...
    for file_ext in MDL_FILE_EXTS:
        try:
            PulleyLib.Importers.FS.Other.import_file_noLog(file_without_ext + file_ext, depot_path, config_handle, profile)
        except:
            continue
